...
class StacksTransaction {
    constructor(version, auth, payload, postConditions, postConditionMode, anchorMode, chainId) {
        ...
        if ('amount' in payload) {
            this.payload = Object.assign(Object.assign({}, payload), { amount: (0, common_1.intToBigInt)(payload.amount, false) });
        }
        else {
        ...
        this.postConditions = postConditions !== null && postConditions !== void 0 ? postConditions : (0, types_1.createLPList)([]);
        if (anchorMode) {
