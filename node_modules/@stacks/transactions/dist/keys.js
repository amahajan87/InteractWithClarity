...
function publicKeyFromSignatureRsv(messageHash, messageSignature, pubKeyEncoding = constants_1.PubKeyEncoding.Compressed) {
    return publicKeyFromSignatureVrs(messageHash, Object.assign(Object.assign({}, messageSignature), { data: (0, common_1.signatureRsvToVrs)(messageSignature.data) }), pubKeyEncoding);
}
